  ...
  return (
    <div className="outline-none border-none relative">
      <div className="absolute left-[30px] md:left-[70px] max-w-[250px] sm:max-w-[350px] top-[50%] -translate-y-[50%] space-y-2 lg:space-y-4 bg-[#ffffffa2] sm:bg-transparent p-4 sm:p-0 rounded-lg sm:rounded-none">
        <h2 className="text-[24px] lg:text-[28px] bg-blackish text-white md:text-[16px] p-5 rounded-lg cursor-pointer hover:bg-blue-600 text-center font-bold">
          {title}
        </h2>
        ...
        <div className="bg-blackish text-blue-600 text-[14px] md:text-[16px] p-3 rounded-lg inline-block cursor-pointer hover:bg-blue-600 hover:text-white me-5">
          Starting at{" "}
          <b className="text-[16px] md:text-[18px] lg:text-[20px]">{price}</b>
        </div>

        <div className="bg-blackish text-blue-600 text-[14px] md:text-[16px] p-3 rounded-lg inline-block cursor-pointer hover:bg-blue-600 hover:text-white font-bold">
          Shop Now
        </div>
      </div>
